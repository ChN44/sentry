 ...
 * Responsabilidades:
 *   - Exibir formulário de cadastro com nome, email e senha
 *   - Validar nome (mínimo 3 caracteres)
 *   - Validar email (formato correto)
 *   - Validar senha (mínimo 8 caracteres)
 *   - Validar confirmação de senha (deve ser igual)
...
/**
 * COMPONENTE: Cadastro
 * Tela de cadastro de novo usuário com formulário e carousel de imagens
 */
const Cadastro: React.FC = () => {
  ...
  /** Valor do nome digitado no input */
  const [nome, setNome] = useState<string>("");

  /** Valor do email digitado no input */
  const [email, setEmail] = useState<string>("");

  /** Valor da senha digitada no input */
  const [senha, setSenha] = useState<string>("");

  /** Valor da confirmação de senha */
  ...
  // ===== FUNÇÕES AUXILIARES =====
  /**
   * FUNÇÃO: handleNomeChange
   * Gerencia a mudança do input de nome
  ...
  /**
   * FUNÇÃO: handleSenhaChange
   * Gerencia a mudança do input de senha
   */
  ...
  /**
   * FUNÇÃO: handleConfirmaSenhaChange
   * Gerencia a mudança do input de confirmação de senha
   */
   ...
   * Processa o clique no botão "Cadastrar"
   * - Valida todos os campos
   * - Exibe erros específicos se inválidos
  ...
  const handleCadastro = async () => {
    ...
    try {
      ...
      // Navega para autenticação passando os dados do cadastro
